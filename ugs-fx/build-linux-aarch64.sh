...
# for deb/rpm/dmg/exe/msi (and rpm's Version field additionally forbids "-"
# outright), so a tag like v0.1.0-pendant-preview can't be passed through as
# is - strip everything from the first "-" onward.
